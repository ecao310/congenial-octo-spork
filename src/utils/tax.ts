 ...
 * was in this file — six of them numbers, and inserting `seniors` in the
 * middle once silently reassigned a caller's `MAX_CONVERSION` to it. The tests caught that one. Named fields make the same
